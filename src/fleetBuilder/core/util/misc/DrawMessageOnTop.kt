package fleetBuilder.core.util.misc

import com.fs.starfarer.api.GameState
import com.fs.starfarer.api.Global
import fleetBuilder.core.integration.listener.DrawOnTop
import org.lazywizard.lazylib.ui.FontException
import org.lazywizard.lazylib.ui.LazyFont
import org.magiclib.kotlin.setAlpha
import java.awt.Color

internal object DrawMessageOnTop {
    ...
    fun renderStatic() {
        if (toDraw != null && currentMessage != null) {
            ...
            val y = Global.getSettings().screenHeight - (TOP_BUFFER + if (DrawOnTop.curState == GameState.CAMPAIGN) 10f else 0f)
    ...
    fun advanceAmount(amount: Float) {
        if (!init)
            doInit()
