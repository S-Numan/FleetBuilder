package fleetBuilder.features.codexButton
        ...
        when (param) {
            ...
            is ShipHullSpecAPI -> {
                if (ctrl) {
                    ...
                    parsedData = DataVariant.getVariantDataFromVariant(hullVariant)
                }
            }
            ...
            is FleetMemberAPI -> {
                if (ctrl) {
                    ...
                    parsedData = DataMember.getMemberDataFromMember(param)
                }
            }
        }
