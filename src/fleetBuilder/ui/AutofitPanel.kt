...
import fleetBuilder.ui.AutofitSelector.MagicPaintjobSelectorPlugin
import fleetBuilder.ui.AutofitSelector.createAutofitSelector
...
import fleetBuilder.ui.AutofitApplier.applyVariantInRefitScreen
...
internal object AutofitPanel {
    ...
    internal fun createMagicPaintjobRefitPanel(refitTab: UIPanelAPI, refitPanel : UIPanelAPI, coreUI : CoreUIAPI,
        ...
        for (i in allPaintjobs.indices) {
            ...
            variant
            val selectorPanel = createAutofitSelector(variant, paintjobSpec, selectorWidth)
